...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Seccion.puntaje'
        db.delete_column('app_seccion', 'puntaje')

        # Adding field 'Seccion.ponderacion'
        db.add_column('app_seccion', 'ponderacion',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Cuestionario.peso'
        db.add_column('app_cuestionario', 'peso',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Seccion.puntaje'
        db.add_column('app_seccion', 'puntaje',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Seccion.ponderacion'
        db.delete_column('app_seccion', 'ponderacion')

        # Deleting field 'Cuestionario.peso'
        db.delete_column('app_cuestionario', 'peso')
