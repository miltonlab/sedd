...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Seccion.codigo'
        db.add_column('app_seccion', 'codigo',
                      self.gf('django.db.models.fields.CharField')(max_length='20', null=True, blank=True),
                      keep_default=False)


        # Changing field 'Pregunta.codigo'
        db.alter_column('app_pregunta', 'codigo', self.gf('django.db.models.fields.CharField')(max_length='20', null=True))

    def backwards(self, orm):
        # Deleting field 'Seccion.codigo'
        db.delete_column('app_seccion', 'codigo')


        # Changing field 'Pregunta.codigo'
        db.alter_column('app_pregunta', 'codigo', self.gf('django.db.models.fields.CharField')(max_length='5', null=True))
