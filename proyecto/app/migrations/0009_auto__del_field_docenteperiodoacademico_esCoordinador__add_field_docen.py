...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocentePeriodoAcademico.esCoordinador'
        db.delete_column('app_docenteperiodoacademico', 'esCoordinador')
    ...
    def backwards(self, orm):
        # Adding field 'DocentePeriodoAcademico.esCoordinador'
        db.add_column('app_docenteperiodoacademico', 'esCoordinador',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
