...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Seccion.seccionPadre'
        db.delete_column('app_seccion', 'seccion_padre_id')

        # Adding field 'Seccion.superseccion'
        db.add_column('app_seccion', 'superseccion',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subsecciones', null=True, db_column='superseccion_id', to=orm['app.Seccion']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Seccion.seccionPadre'
        db.add_column('app_seccion', 'seccionPadre',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='subsecciones', null=True, to=orm['app.Seccion'], db_column='seccion_padre_id', blank=True),
                      keep_default=False)

        # Deleting field 'Seccion.superseccion'
        db.delete_column('app_seccion', 'superseccion_id')
    ...
    models = {
        ...
        'app.evaluacion': {
            ...
            'directorCarrera': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'evaluaciones'", 'null': 'True', 'to': "orm['app.DocentePeriodoAcademico']"}),
        ...
        'app.pregunta': {
            ...
            'codigo': ('django.db.models.fields.CharField', [], {'max_length': "'5'", 'null': 'True', 'blank': 'True'}),
