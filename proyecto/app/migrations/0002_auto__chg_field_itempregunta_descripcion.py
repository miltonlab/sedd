...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemPregunta.descripcion'
        db.alter_column('app_itempregunta', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length='70', null=True))

    def backwards(self, orm):

        # Changing field 'ItemPregunta.descripcion'
        db.alter_column('app_itempregunta', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length='80', null=True))
