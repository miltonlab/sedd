...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contestacion.observaciones'
        db.add_column('app_contestacion', 'observaciones',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pregunta.observaciones'
        db.add_column('app_pregunta', 'observaciones',
                      self.gf('django.db.models.fields.CharField')(max_length='70', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contestacion.observaciones'
        db.delete_column('app_contestacion', 'observaciones')

        # Deleting field 'Pregunta.observaciones'
        db.delete_column('app_pregunta', 'observaciones')
