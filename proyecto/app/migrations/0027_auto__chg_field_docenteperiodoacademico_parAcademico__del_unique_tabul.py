...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Tabulacion', fields ['tipo']
        db.delete_unique('app_tabulacion', ['tipo'])

        # Changing field 'Asignatura.idSGA'
        db.alter_column('app_asignatura', 'id_sga', self.gf('django.db.models.fields.CharField')(max_length='40', db_column='id_sga'))
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Tabulacion', fields ['tipo']
        db.create_unique('app_tabulacion', ['tipo'])

        # Changing field 'Asignatura.idSGA'
        db.alter_column('app_asignatura', 'id_sga', self.gf('django.db.models.fields.CharField')(max_length='15', db_column='id_sga'))
    ...
    models = {
        ...
        'app.asignatura': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idSGA': ('django.db.models.fields.CharField', [], {'max_length': "'40'", 'db_column': "'id_sga'"}),
        ...
        'app.cuestionario': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'informante': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.TipoInformante']"}),
        ...
        'app.periodoevaluacion': {
            ...
            'areasSGA': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'periodosEvaluacion'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['app.AreaSGA']"}),
