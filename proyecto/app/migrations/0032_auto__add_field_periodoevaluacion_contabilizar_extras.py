...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeriodoEvaluacion.contabilizar_extras'
        db.add_column('app_periodoevaluacion', 'contabilizar_extras',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PeriodoEvaluacion.contabilizar_extras'
        db.delete_column('app_periodoevaluacion', 'contabilizar_extras')
