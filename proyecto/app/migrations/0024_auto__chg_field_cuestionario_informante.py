...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cuestionario.informante'
        db.alter_column('app_cuestionario', 'informante_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['app.TipoInformante']))

    def backwards(self, orm):

        # Changing field 'Cuestionario.informante'
        db.alter_column('app_cuestionario', 'informante_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.TipoInformante'], null=True))
    ...
    models = {
        ...
        'app.seccion': {
            ...
            'orden': ('django.db.models.fields.IntegerField', [], {}),
            'puntaje': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
