...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pregunta.texto'
        db.alter_column('app_pregunta', 'texto', self.gf('django.db.models.fields.TextField')(max_length='250'))

    def backwards(self, orm):

        # Changing field 'Pregunta.texto'
        db.alter_column('app_pregunta', 'texto', self.gf('django.db.models.fields.TextField')(max_length='100'))
    ...
    models = {
        ...
        'app.itempregunta': {
            ...
            'descripcion': ('django.db.models.fields.CharField', [], {'max_length': "'70'", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'app.pregunta': {
            ...
            'texto': ('django.db.models.fields.TextField', [], {'max_length': "'250'"}),
