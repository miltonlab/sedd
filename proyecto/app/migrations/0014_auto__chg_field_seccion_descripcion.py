...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Seccion.descripcion'
        db.alter_column('app_seccion', 'descripcion', self.gf('django.db.models.fields.CharField')(max_length='100', null=True))

    def backwards(self, orm):

        # Changing field 'Seccion.descripcion'
        db.alter_column('app_seccion', 'descripcion', self.gf('django.db.models.fields.CharField')(default=None, max_length='100'))
