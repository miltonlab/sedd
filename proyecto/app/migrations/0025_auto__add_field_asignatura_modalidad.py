...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asignatura.modalidad'
        db.add_column('app_asignatura', 'modalidad',
                      self.gf('django.db.models.fields.CharField')(default='desconocida', max_length='20'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asignatura.modalidad'
        db.delete_column('app_asignatura', 'modalidad')
