...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DocentePeriodoAcademico.migrado'
        db.delete_column('app_docenteperiodoacademico', 'migrado')

        # Adding field 'DocentePeriodoAcademico.parAcademico'
        db.add_column('app_docenteperiodoacademico', 'parAcademico',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DocentePeriodoAcademico.migrado'
        db.add_column('app_docenteperiodoacademico', 'migrado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'DocentePeriodoAcademico.parAcademico'
        db.delete_column('app_docenteperiodoacademico', 'parAcademico')
    ...
    models = {
        ...
        'app.informanteparacademico': {
            'Meta': {'object_name': 'InformanteParAcademico', '_ormbases': ['app.TipoInformante']},
            'tipoinformante_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['app.TipoInformante']", 'unique': 'True', 'primary_key': 'True'})
        },
        'app.itempregunta': {
