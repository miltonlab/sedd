...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PeriodoEvaluacion.titulo'
        db.add_column('app_periodoevaluacion', 'titulo',
                      self.gf('django.db.models.fields.CharField')(default='Periodo Evaluacion Sin Titulo', max_length='300'),
                      keep_default=False)


        # Changing field 'PeriodoEvaluacion.nombre'
        db.alter_column('app_periodoevaluacion', 'nombre', self.gf('django.db.models.fields.CharField')(max_length='100'))

    def backwards(self, orm):
        # Deleting field 'PeriodoEvaluacion.titulo'
        db.delete_column('app_periodoevaluacion', 'titulo')


        # Changing field 'PeriodoEvaluacion.nombre'
        db.alter_column('app_periodoevaluacion', 'nombre', self.gf('django.db.models.fields.CharField')(max_length='300'))
