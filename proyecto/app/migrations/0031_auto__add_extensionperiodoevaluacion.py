...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtensionPeriodoEvaluacion'
        db.create_table('app_extensionperiodoevaluacion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('secuencia', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ...
            ('periodoEvaluacion', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extensiones', to=orm['app.PeriodoEvaluacion'])),
        ))
        db.send_create_signal('app', ['ExtensionPeriodoEvaluacion'])


    def backwards(self, orm):
        # Deleting model 'ExtensionPeriodoEvaluacion'
        db.delete_table('app_extensionperiodoevaluacion')
