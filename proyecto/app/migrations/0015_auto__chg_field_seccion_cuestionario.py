...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Seccion.cuestionario'
        db.alter_column('app_seccion', 'cuestionario_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['app.Cuestionario']))

    def backwards(self, orm):

        # Changing field 'Seccion.cuestionario'
        db.alter_column('app_seccion', 'cuestionario_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.Cuestionario']))
