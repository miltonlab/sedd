...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DireccionCarrera.director'
        db.alter_column('app_direccioncarrera', 'director_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['app.DocentePeriodoAcademico']))

    def backwards(self, orm):

        # Changing field 'DireccionCarrera.director'
        db.alter_column('app_direccioncarrera', 'director_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.DocentePeriodoAcademico']))

    models = {
        'app.areasga': {
            'Meta': {'ordering': "['nombre']", 'object_name': 'AreaSGA'},
        ...
        'app.cuestionario': {
            ...
            'fuente_verificacion': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'app.docenteperiodoacademico': {
            'Meta': {'ordering': "['usuario__last_name', 'usuario__first_name']", 'unique_together': "(('usuario', 'periodoAcademico'),)", 'object_name': 'DocentePeriodoAcademico'},
        ...
        'app.extensionperiodoevaluacion': {
            'Meta': {'ordering': "['inicio', 'fin']", 'object_name': 'ExtensionPeriodoEvaluacion'},
            'fin': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inicio': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'secuencia': ('django.db.models.fields.IntegerField', [], {'unique': 'True'})
        },
        'app.itempregunta': {
        ...
        'app.periodoacademico': {
            'Meta': {'ordering': "['inicio', 'fin']", 'object_name': 'PeriodoAcademico'},
        ...
        'app.periodoevaluacion': {
            ...
            'contabilizar_extras': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
