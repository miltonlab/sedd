...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evaluacion.docentePeriodoAcademico'
        db.add_column('app_evaluacion', 'docentePeriodoAcademico',
        ...
        # Changing field 'Evaluacion.estudianteAsignaturaDocente'
        db.alter_column('app_evaluacion', 'estudianteAsignaturaDocente_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['app.EstudianteAsignaturaDocente']))

    def backwards(self, orm):
        # Deleting field 'Evaluacion.docentePeriodoAcademico'
        db.delete_column('app_evaluacion', 'docentePeriodoAcademico_id')
        ...
        # Changing field 'Evaluacion.estudianteAsignaturaDocente'
        db.alter_column('app_evaluacion', 'estudianteAsignaturaDocente_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.EstudianteAsignaturaDocente']))
    ...
    models = {
        ...
        'app.evaluacion': {
            ...
            'direccionCarrera': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'evaluaciones'", 'null': 'True', 'to': "orm['app.DireccionCarrera']"}),
