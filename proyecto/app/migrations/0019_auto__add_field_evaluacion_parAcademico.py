...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Evaluacion.parAcademico'
        db.add_column('app_evaluacion', 'parAcademico',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='evaluaciones_par_academico', null=True, to=orm['app.DocentePeriodoAcademico']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Evaluacion.parAcademico'
        db.delete_column('app_evaluacion', 'parAcademico_id')
