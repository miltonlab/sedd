...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cuestionario.preguntas_obligatorias'
        db.add_column('app_cuestionario', 'preguntas_obligatorias',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cuestionario.preguntas_obligatorias'
        db.delete_column('app_cuestionario', 'preguntas_obligatorias')
