...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cuestionario.fuente_verificacion'
        db.add_column('app_cuestionario', 'fuente_verificacion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cuestionario.fuente_verificacion'
        db.delete_column('app_cuestionario', 'fuente_verificacion')
