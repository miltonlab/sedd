...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asignatura.periodoAcademico'
        db.add_column('app_asignatura', 'periodoAcademico',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='asignaturas', db_column='periodo_academico_id', to=orm['app.PeriodoAcademico']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asignatura.periodoAcademico'
        db.delete_column('app_asignatura', 'periodo_academico_id')
