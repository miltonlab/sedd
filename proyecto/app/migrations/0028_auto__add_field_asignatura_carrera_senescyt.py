...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Asignatura.carrera_senescyt'
        db.add_column('app_asignatura', 'carrera_senescyt',
                      self.gf('django.db.models.fields.CharField')(default='0000', max_length='10'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Asignatura.carrera_senescyt'
        db.delete_column('app_asignatura', 'carrera_senescyt')
